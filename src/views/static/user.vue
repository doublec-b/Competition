<template>
	<div style="margin-top:10px">
		...
		<el-table :data="users" style="width: 95%; margin:0 auto">
			...
			<el-table-column fixed="right" label="功能管理" width="140">
				<template #default="scope">
					<el-button type="warning" link size="small" @click="toEdit(scope.row)">更新</el-button>
	...
	<el-dialog v-model="dialogFormVisible" title="用户编辑">
		<el-form :model="user">
			<el-form-item label="用户名称" :label-width="formLabelWidth">
				<el-input v-model="user.userName" placeholder="请输入类型名称" style="width:80%;"></el-input>
			</el-form-item>

			<el-form-item label="密码" :label-width="formLabelWidth">
				<el-input v-model="user.password" type="password" placeholder="请输入密码" style="width:80%;"></el-input>
			</el-form-item>

			<el-form-item label="邮箱" :label-width="formLabelWidth">
				<el-input v-model="user.email" type="email" placeholder="请输入邮箱" style="width:80%;"></el-input>
			</el-form-item>

			<el-form-item label="用户类型" :label-width="formLabelWidth">
				<el-select v-model="user.userType" placeholder="请选择用户类型" style="width:80%;">
			...
			<el-form-item label="状态" :label-width="formLabelWidth">
				<el-select v-model="user.state" placeholder="请选择状态" style="width:80%;">
			...
			<el-form-item label="创建时间" :label-width="formLabelWidth">
				<div class="block">
					<el-date-picker v-model="user.createTime" type="datetime" placeholder="请选择创建时间" />
				</div>
			</el-form-item>
